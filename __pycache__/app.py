...
def report_download_xlsx():
    ...
    # Ajusta larguras das colunas (similar ao que você já tinha)
    widths = {
        "A": 18,
        "B": 40,
        "C": 12,
    ...
    # Formatação condicional: status LOW em vermelho (coluna E)
    ...
    # Formatação condicional: quantidade < 0 em vermelho (coluna C)
    ws.conditional_formatting.add(
        "C2:C1048576",
